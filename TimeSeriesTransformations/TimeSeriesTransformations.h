...
public:
    ...
    TimeSeriesTransformations(const std::vector<int>& time, const std::vector<double>& price, const std::string& name = "");
    ...
    void addASharePrice(const std::string& datetime, double price);
    bool removeEntryAtTime(const std::string& time);
